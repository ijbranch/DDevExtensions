...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if UsedInImplementation then
          Placement.Reason := 'Used in both sections - keep in interface'
        else
          Placement.Reason := 'Used in interface section';
      end
      else if UsedInImplementation then
      begin
        Placement.RecommendedSection := usImplementation;
        Placement.Reason := 'Only used in implementation - can move to implementation';
      end
      else
      begin
    ...
    begin
      ...
      begin
        Placement.RecommendedSection := usInterface;
        Placement.Reason := 'Used in interface - should move to interface uses';
      end
      else
        Placement.Reason := 'Correctly placed in implementation';
