...
{$ELSE} // not CPUX86 — Win64 compile-only stubs so FrmReloadFiles still builds

function IsEmbeddedDesigner: Boolean;          begin Result := True; end;
function InitDocModuleHandler: Boolean;        begin Result := False; end;
