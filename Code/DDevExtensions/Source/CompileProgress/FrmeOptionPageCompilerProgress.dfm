inherited FrameOptionPageCompilerProgress: TFrameOptionPageCompilerProgress
  ...
  inherited pnlClient: TPanel
    ...
    object chkEnableBuildStatistics: TCheckBox
      Left = 8
      Top = 168
      Width = 361
      Height = 19
      Caption = 'Enable &build time statistics'
      TabOrder = 7
      OnClick = chkEnableBuildStatisticsClick
    end
    object chkShowBuildStatisticsAfterCompile: TCheckBox
      Left = 24
      Top = 190
      Width = 361
      Height = 19
